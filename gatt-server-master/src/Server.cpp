	...
	GGKServerDataGetter getter, GGKServerDataSetter setter)
{
	...
	.gattServiceBegin("Nordic_UART_Service", "6e400001-b5a3-f393-e0a9-e50e24dcca9e")
		...
		// Characteristic: String value (custom: 6e400002-b5a3-f393-e0a9-e50e24dcca9e) microbit -> 0003
		.gattCharacteristicBegin("UART_RX", "6e400003-b5a3-f393-e0a9-e50e24dcca9e", {"write-without-response","write"})
		...
		// Characteristic: String value (custom: 6e400003-b5a3-f393-e0a9-e50e24dcca9e) microbit -> 0002
		.gattCharacteristicBegin("UART_TX", "6e400002-b5a3-f393-e0a9-e50e24dcca9e", {"notify"})
